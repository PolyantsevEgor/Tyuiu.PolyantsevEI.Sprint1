...
namespace Tyuiu.PolyantsevEI.Sprint1.Task1.V23
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Написать программу, которая которая запрашивает у пользователя исходные *");
            Console.WriteLine("* данные, вычисляет результат по формуле (x * Pi) / (2 * a) и печатает    *");
